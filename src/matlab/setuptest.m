...
comparevec(x_vanilla, x_takasu, 1e-9, "x_vanilla", "x_takasu");
comparevec(x_udu,     x_takasu, 1e-9, "x_udu",     "x_takasu");
comparevec(x_carlson, x_takasu, 1e-9, "x_carlson", "x_takasu");
comparevec(x_carlson, x_udu,    1e-9, "x_carlson", "x_udu");
